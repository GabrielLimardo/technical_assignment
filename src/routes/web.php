...
class Web
{
    ...
    public function __construct()
    {
        $this->routes = [
            ...
            LOGIN_ENDPOINT => ['controller' => new loginController(), 'method' => 'filter', 'request_method' => 'POST'],
            GET_CREATE_TRANSACTION_ENDPOINT => ['controller' => new TransactionsController(), 'method' => 'index', 'request_method' => 'GET'],
            CREATE_TRANSACTION_ENDPOINT => ['controller' => new TransactionsController(), 'method' => 'filter', 'request_method' => 'POST'],
            GET_USERS_ENDPOINT => ['controller' => new usersController(), 'method' => 'index', 'request_method' => 'GET'],
            EDIT_USERS_ENDPOINT => ['controller' => new usersController(), 'method' => 'filter', 'request_method' => 'POST'],
        ];
    }
